  ...
  <div class="body_wrapper">
    ...
    <div class="container_24">
      ...
      <?php include 'includes/banner.php' ?>
         <?php include 'includes/flash-news.php' ?>
      ...
      <div class="grid_24 home_content_wrapper">
        ...
        <div class="home_content">
          <div class="home_text">
            <center>
              <h1>Welcome to Alakar Products</h1>
            </center>
          </div>
          <hr/>
          <div class="clear"></div>
            ...
            <div class="grid_61 alpha">
              <div class="widget_inner">
                ...
                <div class="textwidget">
                  <img src="images/mission.jpg" width="225" height="150">
                </div>
              </div>
            </div>
            <div class="grid_61">
            ...
            <div class="grid_61">
              <div class="widget_inner">
                ...
                <div class="textwidget"><b>Alakar Products</b><br/>
                  ...
                  Perumalpuram, <br/>
                  Tirunelveli.<br/>
                 <b>E-mail:</b> <a href="mailto:alakarchemicals@gmail.com">alakarchemicals@gmail.com</a>, 
                  <br/>
                  <b>Phone:</b> 0462 2531965<br/>
                  <b>Mobile:</b> +91 98429 95109 / +91 94436 14915</div>
              </div>
            </div>
          </div>
          <!--End Footer-->
        ...
        <div class="container_24">
          <div class="grid_24">
            ...
            <div class="footer_bottom_inner">
              ...
              <p class="copyright"> Powered by :<a href="http://www.yamee.co.in/" target="_blank" style="color:#a42103;">YameeCluster</a>. </p>
            </div>
